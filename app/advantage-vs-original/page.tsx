...
export const metadata: Metadata = {
  ...
  description:
    'Compare Medicare Advantage vs Original Medicare costs and benefits for 2026. Free calculator showing total costs, coverage differences, and which plan fits your situation.',
